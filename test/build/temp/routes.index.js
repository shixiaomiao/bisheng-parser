...
const NotFound = require('/Users/shijiale/work/training/bisheng-parser/node_modules/bisheng-theme-one/lib/template/NotFound');
...
module.exports = function getRoutes(data) {
  function templateWrapper(template, dataPath = '') {
    const Template = require(`/Users/shijiale/work/training/bisheng-parser/node_modules/bisheng-theme-one/lib/template${template.replace(/^\.\/template/, '')}`);
  ...
  const themeRoutes = JSON.parse('[{"path":"/","component":"./template/Archive"},{"path":"/posts/:post","dataPath":"/:post","component":"./template/Post"},{"path":"/tags","component":"./template/TagCloud"}]');
